...
namespace BreakTimer
{
	...
	/// "Other potential states" section and the friendly-name lookups that don't live on
	/// <see cref="BreakInfo"/>. Every value cached here is keyed on a <see cref="Def"/>
	/// (plus, for traits, the immutable degree value), so entries are valid for the whole
	/// session — defs never get re-loaded after game startup.
	/// </summary>
	/// <remarks>
